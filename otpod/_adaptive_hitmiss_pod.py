...
class AdaptiveHitMissPOD(POD):
    ...
    **Available constructor:**
    ...
    def __init__(self, inputDOE, outputDOE, physicalModel=None, nMorePoints=0,
                 detection=None, noiseThres=None, saturationThres=None):

        # initialize the POD class
        boxCox = False
        super(AdaptiveHitMissPOD, self).__init__(inputDOE, outputDOE,
        ...
        if detection is None:
            ...
            if parse_version(ot.__version__) < parse_version("1.18"):
                ...
                self._physicalModel = ot.IndicatorFunction(ot.LevelSet(physicalModel,
                                                 ot.Greater(), self._detection))
