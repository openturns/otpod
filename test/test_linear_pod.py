...
def test_1_a90():
    np.testing.assert_almost_equal(detectionSize1[0], 0.30903, decimal=5)
...
def test_2_a9095():
    np.testing.assert_almost_equal(detectionSize2[1], 0.31420, decimal=5)


# Test linear regression with no hypothesis on residuals, low censored data and Box Cox
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD3 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, boxCox=True
)
POD3.run()
...
def test_3_a90():
    np.testing.assert_almost_equal(detectionSize3[0], 0.29834, decimal=5)


def test_3_a9095():
    np.testing.assert_almost_equal(detectionSize3[1], 0.30671, decimal=5)


# Test linear regression with no hypothesis on residuals, high censored data and Box Cox
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD4 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, None, saturationThres, boxCox=True
)
POD4.run()
...
def test_7_a90():
    np.testing.assert_almost_equal(detectionSize7[0], 0.31423, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD8 = otpod.UnivariateLinearModelPOD(
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD9 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, boxCox=False
)
POD9.run()
...
def test_9_a90():
    np.testing.assert_almost_equal(detectionSize9[0], 0.32576, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD10 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, None, saturationThres, boxCox=False
)
POD10.run()
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD13 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, resDistFact=resDistFact, boxCox=True
)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD14 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    noiseThres,
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD15 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, resDistFact=resDistFact, boxCox=True
)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD16 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    None,
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
analysis = otpod.UnivariateLinearModelAnalysis(
    defects, signals, resDistFact=resDistFact, boxCox=True
)
ot.RandomGenerator.SetSeed(0)
...
ot.RandomGenerator.SetSeed(0)
analysis = otpod.UnivariateLinearModelAnalysis(
    defects, signals, noiseThres, saturationThres, resDistFact=resDistFact, boxCox=True
)
ot.RandomGenerator.SetSeed(0)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD19 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, resDistFact=resDistFact, boxCox=False
)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD20 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    noiseThres,
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD21 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, resDistFact=resDistFact, boxCox=False
)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD22 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    None,
...
ot.RandomGenerator.SetSeed(0)
analysis = otpod.UnivariateLinearModelAnalysis(
    defects, signals, resDistFact=resDistFact, boxCox=False
)
ot.RandomGenerator.SetSeed(0)
...
ot.RandomGenerator.SetSeed(0)
analysis = otpod.UnivariateLinearModelAnalysis(
    defects, signals, noiseThres, saturationThres, resDistFact=resDistFact, boxCox=False
)
ot.RandomGenerator.SetSeed(0)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD25 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, resDistFact=resDistFact, boxCox=True
)
POD25.run()
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD26 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    noiseThres,
...
def test_26_a90():
    np.testing.assert_almost_equal(detectionSize26[0], 0.31159, decimal=5)


def test_26_a9095():
    np.testing.assert_almost_equal(detectionSize26[1], 0.32381, decimal=5)


# Test linear regression with no hypothesis on residuals, low censored data and Box Cox
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD27 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, resDistFact=resDistFact, boxCox=True
)
POD27.run()
...
def test_27_a90():
    np.testing.assert_almost_equal(detectionSize27[0], 0.31307, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD28 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    None,
...
def test_28_a90():
    np.testing.assert_almost_equal(detectionSize28[0], 0.30975, decimal=5)
...
def test_29_a90():
    np.testing.assert_almost_equal(detectionSize29[0], 0.31310, decimal=5)
...
def test_30_a90():
    np.testing.assert_almost_equal(detectionSize30[0], 0.31159, decimal=5)


def test_30_a9095():
    np.testing.assert_almost_equal(detectionSize30[1], 0.32381, decimal=5)


# Test without Box Cox
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD31 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, resDistFact=resDistFact, boxCox=False
)
POD31.run()
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD32 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    noiseThres,
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD33 = otpod.UnivariateLinearModelPOD(
    defects, signals, detection, noiseThres, None, resDistFact=resDistFact, boxCox=False
)
POD33.run()
...
def test_33_a90():
    np.testing.assert_almost_equal(detectionSize33[0], 0.33876, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD34 = otpod.UnivariateLinearModelPOD(
    defects,
    signals,
    detection,
    None,
...
dataFiltered = otpod.DataHandling.filterCensoredData(
    defects, signals, noiseThres, saturationThres
)
# linear regression binomial
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD37 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0], dataFiltered[3], detection, resDistFact=None, boxCox=False
)
POD37.run()
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD38 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0], dataFiltered[3], detection, resDistFact=None, boxCox=True
)
POD38.run()
...
def test_38_a90():
    np.testing.assert_almost_equal(detectionSize38[0], 0.28593, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD39 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0],
    dataFiltered[3],
    detection,
    resDistFact=ot.NormalFactory(),
...
def test_39_a9095():
    np.testing.assert_almost_equal(detectionSize39[1], 0.33068, decimal=5)


# linear regression Gauss with box cox
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD40 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0],
    dataFiltered[3],
    detection,
    resDistFact=ot.NormalFactory(),
...
def test_40_a90():
    np.testing.assert_almost_equal(detectionSize40[0], 0.29914, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD41 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0],
    dataFiltered[3],
    detection,
    resDistFact=ot.KernelSmoothing(),
...
def test_41_a90():
    np.testing.assert_almost_equal(detectionSize41[0], 0.31606, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD42 = otpod.UnivariateLinearModelPOD(
    dataFiltered[0],
    dataFiltered[3],
    detection,
    resDistFact=ot.KernelSmoothing(),
