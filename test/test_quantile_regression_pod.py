...
def test_1_a95():
    np.testing.assert_almost_equal(detectionSize1[1], 0.3027828722824481)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD2 = otpod.QuantileRegressionPOD(
...
def test_2_a95():
    np.testing.assert_almost_equal(detectionSize2[1], 0.31470276646338957, decimal=5)
...
def test_3_a95():
    np.testing.assert_almost_equal(detectionSize3[1], 0.3440539465229369, decimal=5)
...
np.random.seed(0)
ot.RandomGenerator.SetSeed(0)
POD4 = otpod.QuantileRegressionPOD(
...
def test_4_a95():
    np.testing.assert_almost_equal(detectionSize4[1], 0.3171394108490311)
